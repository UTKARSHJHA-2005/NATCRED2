...
export default function EnergyProduct() {
  ...
  return (
    <section className="py-16 bg-gray-300" //style={{ background: 'radial-gradient(circle,#95d5b2,#52b788)'}}
    >
      <div className="container mx-auto px-6">
        <div className="flex justify-center mb-6">
          <FontAwesomeIcon icon={faSolarPanel} className="text-4xl text-black" />
        </div>
        <h2 className="text-4xl font-bold text-center mb-6">Energy Innovators</h2>
          ...
          {projects.map((project, index) => (
            <SwiperSlide key={index}>
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                <img src={project.image} alt={`Image of ${project.title}`} className="w-full h-48 object-cover" />
                <div className="p-6">
